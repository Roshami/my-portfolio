...
export default function Home() {
    return (
        <div className="flex h-screen bg-tertiary relative">
            ...
            <div className="bg-[#f5f5f5] flex w-[90%] h-[85%]  ml-[12%] mr-[2%] max-md:ml-[20%] mt-[6%] max-lg:mt-[8%] max-md:mt-[12%] max-sm:mt-[17%] rounded-4xl inset-shadow-sm inset-shadow-indigo-950/55 overflow-auto scrollbar p-[5%]">
            <Routes>
